...
class Agent_transaction_model extends CI_Model {
    ...
    function trans_count() { 
       $this->db->select('a.`id`,`a.agent_id`,b.`mobile`,a.`credit`,a.`debit`,a.remark,a.`create_date`,a.`status`,b.first_name');
       $this->db->from('agent_transaction a');

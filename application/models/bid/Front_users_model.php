...
class Front_users_Model extends CI_Model {
    ...
    function all_user_count($block = 0) {
        $this->db->select('a.`id`,`a.first_name`,`a.last_name`,a.`mobile`,a.`email`,a.`created_at`,a.`status`,a.commision,a.user_type');
        $this->db->from('bid_front_users a');
